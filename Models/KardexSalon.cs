...
namespace Puerto92.Models
{
    ...
    public class KardexSalon
    {
        ...
        /// <summary>
        /// Descripción de faltantes (REQUERIDO cuando hay diferencias)
        /// </summary>
        [Required(ErrorMessage = "La descripción de faltantes es obligatoria")]
        [StringLength(1000)]
    ...
    public class KardexSalonDetalle
    {
        ...
        /// <summary>
        /// Diferencia (Inventario Inicial - Unidades Contadas)
        /// </summary>
        public int Diferencia { get; set; }

        /// <summary>
        /// Indica si hay faltantes (diferencia > 0)
        /// </summary>
